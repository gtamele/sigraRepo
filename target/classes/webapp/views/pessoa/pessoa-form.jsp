...
<c:import url="/cabecalho.jsp" />
	<form id="pessoaForm" action="/sigra/pessoa/save" method="post" modelAttribute="pessoa" >
				...
				<tr>
					<td>
						<table width="100%">
							<tr>
								<td>							  
									<c:set var="disabled" value="${currStepPessoa == 'VISUALIZAR' ? 'disabled' : ''}" />
									<fieldset>
										...
										<table width="100%">
											...
											<tr>
												...
												<td width="35%" align="left" >
													<c:choose>
														<c:when test="${currStepPessoa != 'VISUALIZAR'}">
															<select name="naturalidade" id="naturalidade" style=" width : 355px;" value="${pessoa.naturalidade}"> 
																<option> </option>
														...
														<c:otherwise>
															<input type="text" name="naturalidade" id="naturalidade" style=" width : 350px;" value="${pessoa.naturalidade}" ${disabled}>
														</c:otherwise>
													</c:choose>
												</td>
												<td width="5%" ></td>
