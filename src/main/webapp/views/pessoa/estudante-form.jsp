								...
								<table width="100%">
									<tr  >
										...
										<td width="35%" align="left"> 
											<input name="nome" id="nome" style="width: 350px""  readonly="readonly">
										...
										<td width="35%">
											<input name="apelido" id="apelido" style="width: 350px"  readonly="readonly">
										</td>
									</tr>
									...
									<tr>
										...
										<td width="35%" align="left" >
											<input type ="radio" name="radioIsTrab"  id="trabSim" value = true  ${estudante.trabalhador==true? 'checked' : ''} onclick="isTrabSelector();" > <label>Sim </label>
											<input type ="radio" name="radioIsTrab"  id="trabNao"  value = false  onclick="isTrabSelector();"> <label>N&atilde;o </label>
										</td>
													...
													<fieldset >
														<table width="100%">
															<tr>
																...
																<td width="35%">
																	<input type ="text" name="localTrab"  id="localTrab"  value="${estudante.localTrab}" >
																</td>
																<td width="5%">
																	<label>Profiss&atilde;o:</label>
																</td>
																<td width="35%"> 
																	<input type="text" name="profissao" id="profissao" style="width: 350px" value="${estudante.profissao}"  >
																</td>
															</tr>
														</table>
													</fieldset>
							...
							<fieldset>
								...
								<table width="100%">
									<tr >
										...
										<td width="35%"> 
											<input type="text" name="encarregadoNome" id="encarregadoNome" style="width: 350px" value="${estudante.encarregadoNome}"  >
										</td>
										<td width="5%" 	>
											<label>Profiss&atilde;o:</label>
										</td>
										<td width="35%">
											<input type ="text" name="encarregadoProfissao"  id="encarregadoProfissao" style="width: 350px" value="${estudante.encarregadoProfissao}" >
										</td>
									</tr>
									...
									<tr >
										...
										<td width="35%"> 
											<input type="text" name="encarregadoCell" id="encarregadoCell" style="width: 350px" value="${estudante.encarregadoCell}"  >
										</td>
										<td>
											<label>TelfFixo:</label>
										</td>
										<td width="35%">
											<input type ="text" name="encarregadoTelf"  id="encarregadoTelf" style="width: 350px" value="${estudante.encarregadoTelf}"  >
										</td>
									</tr>
								</table>
							</fieldset>
